...
这是慕课网的课程，详情请戳[Vue2.5入门](https://www.imooc.com/learn/694)，非常好的一门课程，让我对Vue基础且重要的某些知识有了进一步的认识与理解，在[这份源码中]()，[test.html]()是使用最原始的方式进行编写的，粘贴复制能够直接运行，剩下的就是通过vue-cli来实现的，至于该如何运行vue-cli构建的项目呢，大家自行上网百度一下，下面请看我的一些总结。
